"""TUANDROMD Android-malware detection evaluator.

Reads candidate predictions from OUTPUT_DIR, scores binary malware-detection F1
against the hidden ground truth here, writes score.json as
{instance: {metric_name: value}}. Same verifier-integrity boundary as the other
cyber-ML tasks: ground truth stays here, predictions arrive under OUTPUT_DIR.
"""
import json
import os
